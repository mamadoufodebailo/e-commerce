...
import fd.app.domain.Category;
import fd.app.service.CategoryService;
...
/**
 * REST controller for managing {@link fd.app.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    public ResponseEntity<List<Category>> getAllCategories(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
