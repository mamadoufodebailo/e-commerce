...
import fd.app.domain.Country;
import fd.app.service.CountryService;
...
/**
 * REST controller for managing {@link fd.app.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    public ResponseEntity<List<Country>> getAllCountries(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
