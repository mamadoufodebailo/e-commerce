...
import fd.app.domain.Department;
import fd.app.service.DepartmentService;
...
/**
 * REST controller for managing {@link fd.app.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    public ResponseEntity<List<Department>> getAllDepartments(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
