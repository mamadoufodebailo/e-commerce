...
import fd.app.service.RegionService;
...
/**
 * REST controller for managing {@link fd.app.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
     ...
     */
    @GetMapping("/regions")
    public ResponseEntity<List<Region>> getAllRegions(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
